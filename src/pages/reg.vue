      ...
      <v-container fluid bg="#FAFAFA" class="min-h-[calc(100vh-64px)]">
        <v-sheet color="#FAFAFA" class="mx-auto mt-10">
          ...
          <v-text-field
            ...
            placeholder="Enter your password" prepend-inner-icon="i-mdi-key" variant="solo"
          />
          <v-text-field
            :rules="[value => !!value || 'Password is required']" density="compact"
            placeholder="Enter your password" prepend-inner-icon="i-mdi-wallet-giftcard" variant="solo"
          />
